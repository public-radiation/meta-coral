...
SRC_URI = "git://coral.googlesource.com/imx-atf;protocol=https;branch=master \
    file://0002-LF-7968-01-fix-Makefile-Suppress-array-bounds-error.patch \
"
SRCREV = "91af6468f66ad9b4219ad6333756015b54bdd109"
S = "${WORKDIR}/git"
...
do_compile() {
    ...
    oe_runmake ARM_ARCH_MAJOR=8 all bl31
    if ${BUILD_OPTEE}; then
